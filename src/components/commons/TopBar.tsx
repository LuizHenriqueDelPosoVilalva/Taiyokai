...
function TopBar () {
    return (
        <Flex bg="black" w="100%" alignItems="center">
            <Text ml="5%" fontSize='1.2rem' w="70%" as='b' color="#ED3135">Taiyokai Associação Taiyo Kai Shotocan - Karatê</Text>
            <Flex alignItems="center" w="30%" height="50px" bg="black" justifyContent="flex-end" pt="4%" pb="4%" pr="5%" gap="7%">
